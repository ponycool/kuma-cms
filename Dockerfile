...
# 修改配置文件
RUN sed -i 's/public array \$proxyIPs = \[\];/public array \$proxyIPs = \["172\.0\.0\.1\/8"=>"X-Forwarded-For","127\.0\.0\.1"=>"X-Forwarded-For","192\.168\.0\.0\/24"=>"X-Forwarded-For"\];/g' "$APP_PATH/app/Config/App.php"
