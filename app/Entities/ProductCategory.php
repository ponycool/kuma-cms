...
class ProductCategory extends Base
{
    ...
    public function __construct(array $data = null)
    {
        ...
        try {
            ...
            log_message(
                'error',
                '初始化 ProductCategory Entity 失败，error：{msg}',
                ['msg' => $e->getMessage()]
            );
        }
    }
     ...
     * @throws Exception
     */
    public function setUuid(string $uuid = ''): ProductCategory
    {
     ...
     * @return $this
     */
    public function setPid(int $pid): ProductCategory
    {
        $this->pid = $pid;
     ...
     * @return $this
     */
    public function setIcon(int $icon): ProductCategory
    {
        $this->icon = $icon;
     ...
     * @return $this
     */
    public function setLevel(int $level): ProductCategory
    {
        $this->level = $level;
     ...
     * @return $this
     */
    public function setSortIndex(int $sort_index): ProductCategory
    {
